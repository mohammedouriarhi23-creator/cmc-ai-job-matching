  ...
  return (
    <div>
      ...
      <p className="mb-6 text-sm text-gray-500">
        Ajoutez votre CV pour compléter votre profil et augmenter vos chances d'être sélectionné.
      </p>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <Card className="p-7">
          ...
          <dl className="flex flex-col gap-3 text-sm">
            ...
            <div className="flex justify-between border-b border-gray-100 pb-2">
              <dt className="text-gray-500">CMC de rattachement</dt>
              <dd className="font-medium text-gray-900">{user?.cmc}</dd>
            </div>
            <div className="flex justify-between">
              <dt className="text-gray-500">Année de formation</dt>
